...
public:
  ...
  Position centroid_at(gsl::index local_elem) const;
  ...
  double volume_at(gsl::index local_elem) const;
  ...
  //! \return Error code
  int set_heat_source_at(gsl::index local_elem, double heat);
  ...
  std::size_t lelg_;             //!< upper bound on number of mesh elements
  std::size_t lelt_;             //!< upper bound on number of mesh elements per rank
  std::size_t lx1_;              //!< polynomial order of the solution
  std::size_t nelgt_;            //!< total number of mesh elements
  std::size_t nelt_;             //!< number of local mesh elements
